...
def home_view(request):
    ...
    return render(request,'blood/navbar.html')
...
def create_event(request):
    if request.method == 'POST':
        ...
        form = EventForm()
    return render(request, 'blood/create_event.html', {'form': form})
...
def event_list(request):
    ...
    return render(request, 'blood/event_list.html', {'events': events})
